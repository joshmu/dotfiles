...
function M.openIDEAtPosition(shouldCloseBuffer, ideShellCmd)
...
function M.openIDEWithWorkspaceEnabledIfAvailable(ideShellCmd)
  ideShellCmd = ideShellCmd or 'code' -- Default to vscode
  ...
  M.openIDEAtPosition(false, ideShellCmd)
